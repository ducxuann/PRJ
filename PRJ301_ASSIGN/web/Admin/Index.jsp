<%-- 
    Document   : Index.jsp
    Created on : Oct 28, 2022, 9:35:28 PM
    Author     : Tran Hieu
--%>
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            ...
                            <h2 class="mb-4 text-dark font-weight-bold">${countOrders==null?"0":countOrders}</h2>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal">Total Product</h5>
                            <h2 class="mb-4 text-dark font-weight-bold">${countProduct==null?"0":countProduct}</h2>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-3  col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h5 class="mb-2 text-dark font-weight-normal">Total Money Order</h5>
                            <h2 class="mb-4 text-dark font-weight-bold"><fmt:formatNumber value="${totalMoneyOrders}" type="number" pattern="#,###đ" /></h2>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            ...
                            <h2 class="mb-4 text-dark font-weight-bold">${countUsers==null?"0":countUsers}</h2>
                          </div>
                        </div>
                      </div>
                    </div>
