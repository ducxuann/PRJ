 ...
 * @author win
 */
public class ProcessEditProfileControl extends HttpServlet {
...
//            out.println("<h1>" + uid + "</h1>");
            ...
            dao.editProfile(firstname, lastname, gender, email, phone, address, uid);
            Account getNewAccount = dao.getListAccount(user);
            
            request.setAttribute("getNewAccount", getNewAccount);
